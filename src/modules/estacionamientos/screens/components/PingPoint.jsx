...
const GoogleMapsPinButton = ({ onPress, direccion, tipo, exclusividad }) => {
  return (
    <TouchableOpacity onPress={() => onPress(direccion)}>
          ...
          tipo == "carro" && exclusividad == "libre" ? (
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
              ...
              cx="13.0" cy="8.5" r="9" fill="#229D0E" strokeWidth={1} />
              <Circle cx="13.0" cy="8.5" r="7" fill="#229D0E" strokeWidth={1} stroke={"#000"} />
              <Image
                x="6.5"
                y="2"
                width="13"
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
                ...
                <Circle cx="13.0" cy="8.5" r="7" fill="#BB0808" strokeWidth={1} stroke={"#000"} />
                <Image
                  x="6.5"
                  y="2"
                  width="13"
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
                  ...
                  <Circle cx="13.0" cy="8.5" r="7" fill="#C6A80C" strokeWidth={1} stroke={"#000"} />
                  <Image
                    x="6.5"
                    y="2"
                    width="13"
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
                    ...
                    <Circle cx="13.0" cy="8.5" r="7" fill="#106FC8" strokeWidth={1} stroke={"#000"} />
                    <Image
                      x="6.5"
                      y="2"
                      width="13"
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
                      ...
                      <Circle cx="13.0" cy="8.5" r="7" fill="#68A8E3" strokeWidth={1} stroke={"#000"} />
                      <Image
                        x="6.5"
                        y="2"
                        width="13"
            ...
            1.066.516.445 0 .82-.19 1.067-.516.833-1.3 8.70-11.72 8-15.61C22 5.667 18.573
             ...
             zm0 0"
                        ...
                        <Circle cx="13.0" cy="8.5" r="7" fill="#AFB7A9" strokeWidth={1} stroke={"#000"} />
                        <Image
                          x="6.5"
                          y="2"
                          width="13"
...
export default GoogleMapsPinButton;
